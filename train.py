...
# ---------------------------------------------------------
voc_classes_path = 'C:\\Users\Marwan\PycharmProjects\TinySSD_Banana\TinySSD_Banana\model_data\\voc_classes.txt'
...
def train():
    ...
    try:
        net.load_state_dict(torch.load('C:\\Users\Marwan\PycharmProjects\TinySSD_Banana\TinySSD_Banana\model_data\\result.pt'))
        print("fine-tuning...")
    except:
